...
class Utils {
    ...
    static notification(message, type) {
        ...
        wrapper.innerHTML = [
            ...
            `<div class="alert alert-${type} d-inline-flex align-item-center alert-dismissible fade show" role="alert" style="position: absolute;top: 60px;left: 10px;width: 300px">`,
